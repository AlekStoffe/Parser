...
while a <= 99: #Всего 99 страниц на сайте
    ...
    HEADERS = {
        ...
        'Referer': 'https://auto.ru/tula/cars/bmw/all/',
    ...
    while i <= len(data) - 1: #len(data)-1 это количество пришедших объявлений
        ...
        with open('auto_ru.json', 'a', encoding='UTF-8') as file: #Открываем файл auto_ru.json (создаётся автоматически), на дозапись (ключ a)
